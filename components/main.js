            ...
            <div className="flex items-center">
              <div className="relative group">
                <input
                  ...
                  value={options.customTheme.colorStart || "#ffffff"}
                  onChange={(e) =>
                    setOptions({
                      ...options,
                      customTheme: {
                ...
                <label
                  style={{
                    backgroundColor: options?.customTheme?.colorStart || "#ffffff",
                  }}
            ...
            <div className="flex items-center">
              <div className="relative group">
                <input
                  ...
                  type="color"
                  className="absolute top-0 left-0 w-12 h-12 rounded-full opacity-0 cursor-pointer"
                  value={options.customTheme.colorEnd || "#ffffff"}
                  onChange={(e) =>
                    setOptions({
                      ...options,
                      customTheme: {
                ...
                <label
                  style={{
                    backgroundColor: options?.customTheme?.colorEnd || "#ffffff",
                  }}
                  htmlFor="startColorPicker"
                  className="left-0 flex items-center justify-center w-12  h-12 rounded-full pointer-events-none text-white/50 group-hover:scale-[1.1] duration-100"
                >
